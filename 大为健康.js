...
let userList = [
    {
        "uid": "2098395",
        "Authorization": "c64714789d7f25a4b5ee6e2adsd6d",
        "baseUrl": "https://xb2.xytsq.com",
        "openid": "og1lb69IiOjPsz3xyDWrTYrHp7Ec",
        // "n": 1
    },
    {
        "uid": "2098395",
...
async function main() {
    ...
    if (loginstatus === 1) {
        // console.log(`===========开始答题===========`)
        for (let index = count_money_num; index < ids.length && index < count_money_num + 1; index++) {
